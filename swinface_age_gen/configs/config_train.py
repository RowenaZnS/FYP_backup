...
# Recognition data
config.rec = "/workspace/FYP_backup/swinface_project/dataset/ms1m-arcface/ms1m-arcface"  #### Path for the training dataset
...
config.CelebA_train_label = "/workspace/FYP_backup/swinface_project/dataset/celeba/list_attr_celeba.csv"  # Will use CSV if exists
config.CelebA_val_data = "/workspace/FYP_backup/swinface_project/dataset/celeba/img_align_celeba/img_align_celeba"
config.CelebA_val_label = "/workspace/FYP_backup/swinface_project/dataset/celeba/list_attr_celeba.csv"  # Will use CSV if exists
config.CelebA_test_data = "/workspace/FYP_backup/swinface_project/dataset/celeba/img_align_celeba/img_align_celeba"
config.CelebA_test_label = "/workspace/FYP_backup/swinface_project/dataset/celeba/list_attr_celeba.csv"  # Will use CSV if exists
...
config.total_step = 400000  # Increased from 80000 to get more epochs (about 9 epochs with current batch size)
...
config.output = "/workspace/FYP_backup/swinface_project/output" ####Path for Output
